...
async function requireAuth(req, res, next) {
  // discord-app: this app signs people in with its own session cookie, and
  // src/coreBridge.js has already loaded the same users row this function
  // would (and checked it is active and approved) before any core route runs.
  if (req.user && req.user.__bridged) return next();
